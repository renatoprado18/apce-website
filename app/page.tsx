          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="elevation-3 hover-lift group">
              <CardContent className="p-8">
                ...
                <p className="text-lg mb-6 text-foreground leading-relaxed italic">
                  &ldquo;Renato está com a Vallen desde a construção de nosso planejamento estratégico 2025. Sua contribuição no conselho, para a manutenção do propósito e governança são sempre valiosas, baseadas em sua experiência e enriquecidas com o uso de inteligência artificial.&rdquo;
                </p>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Thalita Mendes</p>
                    <p className="text-sm text-muted-foreground">Fundadora</p>
                    <p className="text-sm text-primary font-medium">Vallen Clinic</p>
                  </div>
                </div>
              </CardContent>
            </Card>

            {/* Depoimento 4 - Marco Carvalho */}
            <Card className="elevation-3 hover-lift group">
              <CardContent className="p-8">
                <div className="mb-6">
                  <svg className="w-12 h-12 text-accent opacity-50" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg mb-6 text-foreground leading-relaxed italic">
                  &ldquo;O conceito de NeoGovernança que Renato propõe me motivou a convidá-lo para ser Diretor de Governança e implementar um conselho consultivo na Federação Assespro-SP. Juntos estamos trabalhando na visão de longo prazo com governança voltada para o futuro.&rdquo;
                </p>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Marco [MAC] Carvalho</p>
                    <p className="text-sm text-muted-foreground">VP Governança e Planejamento</p>
                    <p className="text-sm text-primary font-medium">Federação ASSESPRO-SP</p>
                  </div>
                </div>
              </CardContent>
            </Card>

            {/* Depoimento 5 - Gui Cintra */}
            <Card className="elevation-3 hover-lift group">
              <CardContent className="p-8">
                <div className="mb-6">
                  <svg className="w-12 h-12 text-accent opacity-50" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg mb-6 text-foreground leading-relaxed italic">
                  &ldquo;O aconselhamento do Renato foi fundamental para expandir a Autonomia do Movimento no mercado fitness. Suas orientações sobre o uso estratégico de IA me ajudaram a estruturar soluções inovadoras trazendo clareza e direção para o crescimento do negócio.&rdquo;
                </p>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Gui Cintra</p>
                    <p className="text-sm text-muted-foreground">Fundador</p>
                    <p className="text-sm text-primary font-medium">Autonomia do Movimento</p>
                  </div>
                </div>
              </CardContent>
            </Card>
